  ...
  if (isError && !clinic) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center animate-fade-in px-6">
        ...
        <Button onClick={() => refetch()} className="bg-primary text-primary-foreground px-8 font-bold rounded-xl">
  ...
  return (
    <div className="p-4 md:p-6 max-w-6xl mx-auto animate-in fade-in duration-500">
      <div className="mb-8 flex items-center gap-4 border-b border-border pb-6">
        ...
        <div>
          <h1 className="text-2xl md:text-3xl font-black text-foreground tracking-tight font-display">Produtos & Estoque</h1>
          <p className="text-muted-foreground text-sm font-medium">Gerencie o inventário e a venda de produtos do seu negócio.</p>
        </div>
      </div>

      <div className="bg-card border border-border rounded-2xl md:rounded-3xl p-1 md:p-6 shadow-sm">
        <InventoryTab barbershopId={clinic.id} />
      </div>

      <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-card border border-border rounded-2xl p-4 flex flex-col items-center text-center gap-2 shadow-sm">
