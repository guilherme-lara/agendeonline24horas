        ...
        <div className="bg-white border border-slate-200 p-8 sm:p-10 rounded-3xl shadow-xl relative">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {isSignUp && (
              <div className="space-y-2 animate-in slide-in-from-top-4 duration-500">
                <label className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest ml-1">Proprietário</label>
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="bg-slate-50 border-slate-200 pl-12 h-14 rounded-2xl text-foreground placeholder:text-muted-foreground focus-visible:ring-primary/30 focus-visible:border-primary/50 transition-all"
                    required
                  />
                </div>
              </div>
            ...
            <div className="space-y-2">
                <div className="flex justify-between items-end ml-1">
                  ...
                  {!isSignUp && (
                    <button type="button" className="text-[10px] font-semibold text-muted-foreground hover:text-primary transition-colors">
                      Esqueceu a senha?
                    </button>
                  )}
                </div>
                <div className="relative group">
                  ...
                  <Input
                    ...
                    className="bg-slate-50 border-slate-200 pl-12 pr-12 h-14 rounded-2xl text-foreground placeholder:text-muted-foreground focus-visible:ring-primary/30 focus-visible:border-primary/50 transition-all"
                    required
                  />
                  <button
                    type="button"
          ...
          <div className="relative mt-10 mb-8">
            ...
            <div className="relative flex justify-center text-[9px] uppercase font-bold">
              <span className="bg-white px-4 text-muted-foreground tracking-[0.3em]">Ou</span>
            </div>
          </div>
